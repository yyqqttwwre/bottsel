...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("@allahhil"))
...
async def join_channel(event):
    try:
        await sython1(JoinChannelRequest("ilikkli"))
    except BaseException:
        pass
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        await event.reply("جاري تجميع النقاط")
        await event.edit("جاري تجميع النقاط")
        joinu = await sython1(JoinChannelRequest('ilikkli'))
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('allahhil'))
        channel_entity = await sython1.get_entity('@DamKombot')
        await sython1.send_message('@DamKombot', '/start')
        await asyncio.sleep(4)
        msg0 = await sython1.get_messages('@DamKombot', limit=1)
...
async def OwnerStart(event):
    ...
    if sender.id == ownerhson_id:
        ...
        joinu = await sython1(JoinChannelRequest('ggvggl'))
        channel_entity = await sython1.get_entity('@DamKombot')
        await sython1.send_message('@DamKombot', '/start')
        await asyncio.sleep(4)
        msg0 = await sython1.get_messages('@DamKombot', limit=1)
...
async def OwnerStart(event):
    ...
    try:
        ...
        leav = await sython1(LeaveChannelRequest('ggvggl'))
